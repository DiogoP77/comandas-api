...
from domain.schemas.AuditoriaSchemas import AuditoriaResponse, FuncionarioSimple
...
async def listar_acoes_disponiveis(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Erro ao listar ações disponíveis: {str(e)}"
        )