...
const Navbar = ({ mode, toggleTheme }) => {
  ...
  const drawer = (
    ...
    >
      ...
      >
        <RestaurantMenu sx={{ color: "#f59e0b" }} />
  ...
  return (
    ...
    >
      <Toolbar sx={{ minHeight: 70, px: { xs: 1, sm: 2 } }}>
        ...
        >
          <RestaurantMenu sx={{ color: "#fff", fontSize: 34 }} />
          <Typography
            variant="h5"
            sx={{ fontWeight: 800, color: "white", display: { xs: "none", sm: "block" } }}
          >
            Comandas do Zé
          </Typography>
          <Typography
            variant="h6"
            sx={{ fontWeight: 800, color: "white", display: { xs: "block", sm: "none" } }}
          >
            Zé
          </Typography>
        </Box>
